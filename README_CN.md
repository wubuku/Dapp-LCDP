...
他有超过二十年的软件开发经验，DDD 专家，DDDML 的创造者，技术图书[《深入实践 DDD：以 DSL 驱动复杂软件开发》](https://item.jd.com/12834017.html)的作者。同时，他还是第一个 Move 公链 Starcoin 上几个重要的生态基础项目的开发者（Starcoin 上一些生态项目由匿名团队开发）。 
